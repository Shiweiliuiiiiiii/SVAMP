...
for method in all_methods:
    if 'dense' not in method and 'gmp' not in method and 'imp' not in method and 'after' not in method:
        print(method)
...
gts_lth = [75.92, 74.04, 69.62, 19.57, 19.57, 19.57, 19.57, 19.57, 19.57, 19.57]
